                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="group">
                    ...
                    <input
                      ...
                      className="w-full bg-[#F2F2F2] border-2 border-transparent focus:bg-white focus:border-black p-3 font-bold uppercase placeholder-gray-400 focus:outline-none focus:shadow-[4px_4px_0px_0px_#F4D03F] transition-all"
                    />
                  </div>
                  <div className="group">
                    <label className="block text-xs font-black uppercase mb-1 ml-1 group-focus-within:text-[#F4D03F] transition-colors">
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="bg-[#2D2424] h-80 w-full border-2 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,0.3)] relative overflow-hidden group">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center group-hover:scale-110 transition-transform">
                <MapPin
                  size={48}
                  className="text-[#F4D03F] fill-black animate-bounce"
                />
