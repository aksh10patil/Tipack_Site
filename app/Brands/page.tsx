...
export default function BrandsPage() {
  ...
  const brands = [
    ...
    { name: "VINYL HEAVY", icon: Disc, desc: "Record Label", est: "EST 2023" },
    {
      name: "CORE DRILL",
      icon: Target,
      desc: "Construction Tools",
      est: "EST 2015",
    },
    {
      name: "HEX LABS",
      icon: Hexagon,
      desc: "Chemical Research",
      est: "EST 2020",
    },
  ];
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 mb-20">
          ...
          <p className="text-xl font-bold max-w-2xl leading-snug">
            We supply the brands that build things. If you sell scented candles,
            go elsewhere. If you ship engine parts, kettlebells, or
            synthesizers, you're in the right place.
          </p>
        </div>
        ...
        <div className="w-full bg-[#F4D03F] border-y-2 border-black py-3 overflow-hidden whitespace-nowrap mb-20 relative transform -rotate-1 scale-105 shadow-[0px_4px_10px_rgba(0,0,0,0.1)]">
          <div className="animate-marquee inline-block">
            {[...Array(10)].map((_, i) => (
              <span
                key={i}
                className="text-2xl font-black uppercase mx-8 tracking-widest"
              >
            ...
            <div className="flex flex-col md:flex-row gap-12 items-start">
              ...
              <div className="md:w-1/3">
                ...
                <p className="text-gray-400 font-mono text-sm max-w-xs">
                  Intercepted communications from logistics managers and
                  warehouse ops who actually use our gear.
                </p>
              </div>
              ...
              <div className="md:w-2/3 grid gap-8">
                {testimonials.map((t) => (
                  <div
                    key={t.id}
                    className="bg-[#FFFEF9] text-[#2D2424] p-6 border-2 border-gray-600 shadow-[8px_8px_0px_0px_#F4D03F] transform hover:translate-x-1 transition-transform"
                  >
