          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-[#F2F2F2] border-2 border-black p-4 relative flex items-center justify-center overflow-hidden">
              ...
              <div className="relative w-64 h-64 bg-[#dcb888] border-2 border-black shadow-[10px_10px_0px_0px_rgba(0,0,0,0.2)] flex flex-col items-center justify-center transform rotate-3 transition-transform hover:rotate-0 duration-500">
                <div className="absolute top-2 left-2 text-[10px] font-mono border border-black px-1 opacity-50">
                  FRAGILE
                </div>
            ...
            <div className="flex-1 bg-white border-2 border-black p-0 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
              ...
              <div className="p-6 space-y-6">
                <div className="flex gap-4">
                  <div className="w-12 h-12 bg-gray-100 border-2 border-black flex items-center justify-center font-black text-xl">
                    1
                  </div>
                  <div>
                ...
                <div className="flex gap-4">
                  <div className="w-12 h-12 bg-[#F4D03F] border-2 border-black flex items-center justify-center font-black text-xl">
                    2
                  </div>
                  <div>
        ...
        <div id="design" className="mb-20 scroll-mt-28">
          ...
          <div className="relative inline-block mb-8 transform -rotate-1">
            <div
              className="absolute left-[-11px] top-0 bottom-0 w-[12px]"
              style={{
                backgroundImage: `url("${serratedBlueLeft}")`,
                backgroundSize: "12px 12px",
              }}
            />
            <div
              className="absolute right-[-11px] top-0 bottom-0 w-[12px]"
              style={{
                backgroundImage: `url("${serratedBlueRight}")`,
                backgroundSize: "12px 12px",
              }}
            />
          ...
          <div className="bg-[#2D2424] text-[#FFFEF9] border-2 border-black p-8 shadow-[8px_8px_0px_0px_#60A5FA] relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col md:flex-row gap-12 items-center">
              ...
              <div className="w-full md:w-1/2 aspect-video border-2 border-white/20 bg-[#1a1515] p-4 relative">
                ...
                <svg
                  viewBox="0 0 200 120"
                  className="w-full h-full stroke-white/80 fill-none stroke-[0.5]"
                >
                  ...
                  <text
                    x="100"
                    y="115"
                    className="fill-white text-[6px] font-mono text-center"
                    textAnchor="middle"
                  >
                    400mm
                  </text>
                  <text
                    x="10"
                    y="60"
                    className="fill-white text-[6px] font-mono text-center rotate-[-90deg]"
                    textAnchor="middle"
                  >
                    250mm
                  </text>
