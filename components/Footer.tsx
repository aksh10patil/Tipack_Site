...
import { Instagram, Twitter, Facebook, Linkedin, Heart, ArrowRight } from 'lucide-react';
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-16">
                    ...
                    <div className="md:col-span-4 space-y-6">
                        ...
                        <p className="font-medium text-lg leading-relaxed opacity-90">
                            The packaging company that hates boring brown boxes. We help brands stand out before the customer even opens the package.
                        </p>
                        
                        {/* Newsletter Mini-Form */}
                        <div className="pt-4">
                            <p className="text-sm font-bold uppercase tracking-widest opacity-60 mb-2">Join the club</p>
                    ...
                    <div className="md:col-span-8 grid grid-cols-2 md:grid-cols-3 gap-8">
                        ...
                        <div>
                            ...
                            <ul className="space-y-4 font-bold text-black/70">
                                <li><Link href="#" className="hover:text-black hover:translate-x-1 inline-block transition-all">Mailer Boxes</Link></li>
                                <li><Link href="#" className="hover:text-black hover:translate-x-1 inline-block transition-all">Poly Mailers</Link></li>
                                <li><Link href="#" className="hover:text-black hover:translate-x-1 inline-block transition-all">Custom Tape</Link></li>
                                <li><Link href="#" className="hover:text-black hover:translate-x-1 inline-block transition-all">Tissue Paper</Link></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-4 font-bold text-black/70">
                                <li><Link href="#" className="hover:text-black hover:translate-x-1 inline-block transition-all">Our Story</Link></li>
                                <li><Link href="#" className="hover:text-black hover:translate-x-1 inline-block transition-all">Sustainability</Link></li>
                                <li><Link href="#" className="hover:text-black hover:translate-x-1 inline-block transition-all">Design Guide</Link></li>
                                <li><Link href="#" className="hover:text-black hover:translate-x-1 inline-block transition-all">FAQ</Link></li>
                            </ul>
                        </div>
                        ...
                        <div className="col-span-2 md:col-span-1">
                            ...
                            <div className="flex gap-4">
                                <a href="#" className="w-12 h-12 bg-white border-2 border-black flex items-center justify-center rounded-full hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 transition-all">
                                    <Instagram size={20} />
                                </a>
                                <a href="#" className="w-12 h-12 bg-white border-2 border-black flex items-center justify-center rounded-full hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 transition-all">
                                    <Twitter size={20} />
