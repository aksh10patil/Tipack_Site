...
export default function TipackComparisonTable({
  rows,
}: TipackComparisonTableProps) {
  return (
    <div className="bg-white rounded-[2rem] border-2 border-[var(--color-text-main)] shadow-xl overflow-hidden p-8 mx-auto max-w-4xl">
      <div className="grid grid-cols-3 gap-6 mb-8 text-center text-[var(--color-text-main)]">
        <div className="flex items-center justify-start text-xl font-bold italic">
          Features
        </div>
        <div className="flex flex-col items-center">
          <span className="text-sm font-medium uppercase tracking-wider text-[var(--color-text-sub)]">
            Them
          </span>
